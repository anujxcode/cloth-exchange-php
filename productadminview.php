...
<body id="page-top">
    ...
    if (isset($_GET['delete_id'])) {
        ...
        $result = mysqli_query($conn, $sql);
        if ($result) {
            header("location:productadminview.php?msg=Deleted Successfully");
        }
    }
            ...
            <div id="content">
                ...
                <div class="container" >
                    ...
                    <div class="d-flex justify-content-between" id="userdetails">
                        <h4 style="font-weight:600 ;">Product Details</h4>
                        <div>
                            <a href="productupload.php" class="btn btn-outline-primary">Add Product</a>
                        </div>
                    </div>
                    <hr>
                    <?php if (empty($data)) {  ?>
                        ...
                        <p>No Product Yet <br>
                         add new products </p>
                        <a href="productupload.php" class="btn btn-warning">Add Products</a>
                        </div>
                    <?php } else { ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td> <img src="<?php echo $row['pic']; ?>" style="max-width:50px"></td>
                                    <td>
                                        <!-- <a href="#" class="btn btn-outline-success">Edit</a> -->
                                        <a href="productadminview.php?delete_id=<?php echo $row['pid'] ?>" class="btn btn-outline-danger">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
